...
const PersonalityTest = () => {
  ...
  const handleAnswer = (optionIndex) => {
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      navigate("/results"); // Replace with your desired route
    }
  };
  ...
  return (
    <div className="max-w-2xl mx-auto p-6" style={{ backgroundColor: "#DFF2EB" }}>
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold" style={{ color: "#4A628A" }}>
            Personality Test
          </CardTitle>
        </CardHeader>
        <CardContent>
